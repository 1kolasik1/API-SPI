...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen">
      <header className="flex justify-between bg-gray-900  sm:block  pl-[20px] pr-[20px] pt-[30px] pb-[20px] h-[10vh] text-3xl">
      ...
      <footer className="mx-0 sticky top-full h-[10vh]  my-[20px] sm:mx-[100px]">
        <div className="flex justify-between border-solid border-t-2 border-t-black font-bold text-2xl sm:border-t-4">
          <div className="crflex text-gray-400eatorOfSite">
            <div>Created By:</div>
            <a
