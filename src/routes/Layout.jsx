...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen">
      <header className="flex justify-between bg-gray-900  sm:block  pl-[20px] pr-[20px] pt-[30px] pb-[30px]  text-3xl">
      ...
      <footer className="mx-0 sticky top-full  my-[20px] sm:mx-[100px]">
        <div className="flex justify-center items-center border-solid border-t-2 border-t-black font-bold text-2xl sm:border-t-4">
          <div className="flex">
            <div>Created By:</div>
            <a
              className="ml-5 text-gray-400"
              href="https://my-app-phi-ten.vercel.app/"
            >
              nikgor
            </a>
          </div>
